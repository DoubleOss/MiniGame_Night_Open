...
public class GuiChat extends GuiScreen implements ITabCompleter
{
    ...
    public void initGui()
    {
        ...
        this.inputField = new GuiTextField(0, this.fontRenderer, 4, this.height - 12, this.width/2, 12);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        {
            GlStateManager.translate(0, scaleHeight/2, 40);
            GlStateManager.scale(0.5f, 0.5f, 1);
            drawRect(4, this.height - 14, this.width/2 + 40, this.height - 2, Integer.MIN_VALUE);
